...
import { Params } from "../tris/params";
import { SystemInfo } from "../tris/system_info";
import { StoredGame } from "../tris/stored_game";
import {
  PageRequest,
  PageResponse,
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("raffo.tris.tris.Query", "Params", data);
