...
func (*MsgCreateGame) Descriptor() ([]byte, []int) {
	return fileDescriptor_b55062736f1a0d85, []int{0}
}
...
func (m *MsgCreateGame) GetX() string {
	if m != nil {
		return m.X
	}
	return ""
...
func (m *MsgCreateGame) GetO() string {
	if m != nil {
		return m.O
	}
	return ""
...
func (*MsgCreateGameResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b55062736f1a0d85, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgCreateGame)(nil), "raffo.tris.tris.MsgCreateGame")
	proto.RegisterType((*MsgCreateGameResponse)(nil), "raffo.tris.tris.MsgCreateGameResponse")
}

func init() { proto.RegisterFile("tris/tx.proto", fileDescriptor_b55062736f1a0d85) }

var fileDescriptor_b55062736f1a0d85 = []byte{
	// 221 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *msgClient) CreateGame(ctx context.Context, in *MsgCreateGame, opts ...grpc.CallOption) (*MsgCreateGameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/raffo.tris.tris.Msg/CreateGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/raffo.tris.tris.Msg/CreateGame",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "raffo.tris.tris.Msg",
